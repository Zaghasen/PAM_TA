...
import 'eat_stay_detail_page.dart';
import 'package:tapak_jejak/models/mountain.dart';

class EatStayPage extends StatefulWidget {
  const EatStayPage({super.key});

  @override
  State<EatStayPage> createState() => _EatStayPageState();
}

class _EatStayPageState extends State<EatStayPage> {
  ...
  void _search() {
    if (selectedMountain != null &&
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => EatStayDetailPage(
            mountain: Mountain(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'Cicipi hidangan lokal, dukung UMKM, dan nikmati pengalaman kuliner autentik di pegunungan Indonesia! 🍲',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 14,
